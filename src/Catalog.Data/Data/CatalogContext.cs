...
namespace Catalog.Data.Data
{
    public class CatalogContext : ICatalogContext
    {
        public CatalogContext(IOptions<DatabaseSettings> databaseSettings)
        {
            ...
            this.Products = database.GetCollection<Product>(databaseSettings.Value.ProductCollectionName);

            CatalogContextSeed<Product>.SeedData(this.Products, GetPreconfiguredProducts());
        }
